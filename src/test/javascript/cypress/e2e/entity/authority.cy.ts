...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '5295671b-f31f-4d63-86b6-efeb2da661f1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('86b15303-0c7f-4dca-9e33-db15ee6dfc58');
      cy.get(`[data-cy="name"]`).should('have.value', '86b15303-0c7f-4dca-9e33-db15ee6dfc58');
